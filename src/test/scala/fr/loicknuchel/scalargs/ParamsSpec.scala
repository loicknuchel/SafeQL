...
class ParamsSpec extends BaseSpec {
  ...
  describe("Params") {
    ...
    it("should read args and mark them as read") {
      ...
      params.readArg(2) shouldBe Result.Failure(Errs.argNotFound(2), params)
    ...
    it("should read flags and mark them as read") {
      ...
      params.readFlag("f1") shouldBe Result.Failure(Errs.multipleFlagValues("f1", List("a", "b")), params)
      params.readFlag("f3") shouldBe Result.Failure(Errs.noFlagValue("f3"), params)
      params.readFlag("f4") shouldBe Result.Failure(Errs.flagNotFound("f4"), params)
      ...
      params.readFlagOpt("f1") shouldBe Result.Failure(Errs.multipleFlagValues("f1", List("a", "b")), params)
      params.readFlagOpt("f3") shouldBe Result.Failure(Errs.noFlagValue("f3"), params)
      ...
      params.readFlagList("f4") shouldBe Result.Failure(Errs.flagNotFound("f4"), params)
      ...
      params.readFlagNel("f3") shouldBe Result.Failure(Errs.noFlagValue("f3"), params)
      params.readFlagNel("f4") shouldBe Result.Failure(Errs.flagNotFound("f4"), params)
      ...
      params.readFlagBool("f1") shouldBe Result.Failure(Errs.flagHasValues("f1", List("a", "b")), params)
      params.readFlagBool("f2") shouldBe Result.Failure(Errs.flagHasValue("f2", "c"), params)
    }
