...
class ScalaWriterSpec extends BaseSpec {
  ...
  private val writer = ScalaWriter(now)

  describe("ScalaWriter") {
    it("should have setters") {
      val w = new ScalaWriter(now, "dir", "pkg", Writer.IdentifierStrategy.KeepNames, DatabaseConfig())
    ...
    describe("scaladoc") {
      it("should build the default scaladoc") {
        writer.writeScaladoc(now, None, DatabaseConfig()) shouldBe s"/**\n * Class generated by fr.loicknuchel.safeql.gen.writer.ScalaWriter on $now\n */"
      }
      it("should add specific scaladoc") {
        writer.writeScaladoc(now, None, DatabaseConfig(scaladoc = _ => Some("My custom scaladoc"))) shouldBe s"/**\n * My custom scaladoc\n *\n * Class generated by fr.loicknuchel.safeql.gen.writer.ScalaWriter on $now\n */"
      }
    }
